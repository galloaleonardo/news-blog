<div class="container">
    <h4 class="p-title"><b>{{ trans('magazine.featured_news') }}</b></h4>
            ...
            @if (isset($featuredNews[0]))
                <div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block"
                       href="{{ route('magazine.show', ['id' => $featuredNews[0]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[0]->title)]) }}">
                        <img class="image-size"
                             src="{{ asset('/images/news/large') . '/' . $featuredNews[0]->image_link }}"
                             alt="">
            ...
            <div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
                @if (isset($featuredNews[1]))
                    <div class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
                        <a class="pos-relative h-100 dplay-block"
                           href="{{ route('magazine.show', ['id' => $featuredNews[1]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[1]->title)]) }}">
                            <img class="image-size"
                ...
                @if (isset($featuredNews[2]))
                    <div class="pl-5 ptb-5 pl-sm-0 pos-relative h-50">
                        <a class="pos-relative h-100 dplay-block"
                           href="{{ route('magazine.show', ['id' => $featuredNews[2]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[2]->title)]) }}">
                            <img class="image-size"
        ...
        <div class="h-1-3 oflow-hidden">
            @if (isset($featuredNews[3]))
                <div class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
                    <a class="pos-relative h-100 dplay-block"
                       href="{{ route('magazine.show', ['id' => $featuredNews[3]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[0]->title)]) }}">
                        <img class="image-size"
                             src="{{ asset('/images/news/large') . '/' . $featuredNews[3]->image_link }}"
                             alt="">
            ...
            @if (isset($featuredNews[4]))
                <div
                    ...
                    <a class="pos-relative h-100 dplay-block"
                       href="{{ route('magazine.show', ['id' => $featuredNews[4]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[4]->title)]) }}">
                        <img class="image-size"
                             src="{{ asset('/images/news/large') . '/' . $featuredNews[4]->image_link }}"
                             alt="">
            ...
            @if (isset($featuredNews[5]))
                <div
                    ...
                    <a class="pos-relative h-100 dplay-block"
                       href="{{ route('magazine.show', ['id' => $featuredNews[5]->id, 'title' => Illuminate\Support\Str::slug($featuredNews[5]->title)]) }}">
                        <img class="image-size"
                             src="{{ asset('/images/news/large') . '/' . $featuredNews[5]->image_link }}"
                             alt="">
