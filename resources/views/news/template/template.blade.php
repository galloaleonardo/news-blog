...
<head>
    ...
    <link href="/css/styles-news-theme.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <a class="dplay-block btn-brdr-primary mt-20 mb-md-50" href="#"><b>VIEW MORE CRYPTO MINING
                        EVENTS</b></a>
            </div><!-- col-md-9 -->
    ...
    <div class="container">
        <div class="pt-50 pb-20 pos-relative">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="mb-30">
                        <h5 class="color-primary mb-20"><b>CATEGORIES</b></h5>
                        <p class="color-white"><a href="">Category 1</a></p>
                        <p class="color-white"><a href="">Category 2</a></p>
                        <p class="color-white"><a href="">Category 3</a></p>
                        <p class="color-white"><a href="">Category 4</a></p>
                        <p class="color-white"><a href="">Category 5</a></p>
                        <p class="color-white"><a href="">Category 6</a></p>
                    </div><!-- mb-30 -->
                </div><!-- col-md-4 -->
...
<script src="/js/scripts-news-theme.js"></script>
</body>
</html>